...
const USE_CASES: UseCase[] = [
    ...
    },
    {
        ...
        exampleQuery: "Compare survival impact of EGFR methylation vs RNA in BRCA.",
        tools: ["analyze_tcga_survival_associations"],
        icon: Activity,
    },
    // Drug Targets
    ...
    },
    {
        ...
        exampleQuery: "Which genes are tumor-specific antigens (TSA) in T1 tier?",
        tools: ["search_drug_target_index"],
        icon: Dna,
    },
    {
    ...
    },
    {
        ...
        exampleQuery: "Does the HALLMARK_ESTROGEN_RESPONSE_EARLY pathway predict tamoxifen sensitivity?",
